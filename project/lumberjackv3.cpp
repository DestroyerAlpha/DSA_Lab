...
void enqueue(vector<int> &vect, int u);
int dequeue(vector<int> &vect);
...
float FindMax(int x,int y, int t, int n, vector<vector<int>> &desc,int xp, int yp)
{
		vector <int> Q;				//queue for storing cut trees
		Q.clear();					
		v1.push_back(0);
		v2.push_back(0);
		v3.push_back(0);
